...
public class Practice17PathEffect extends View {
    ...
    public Practice17PathEffect(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }


    public Practice17PathEffect(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public Practice17PathEffect(Context context) {
        super(context);
        init();
    }
